...
<section class="mx-auto max-w-360 py-12 px-4 sm:px-8 md:px-10 lg:px-20">
  <div
...
<section class="mx-auto max-w-360 px-4 sm:px-8 md:px-10 lg:px-20 py-10">
  <!-- Header -->
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="min-w-0 flex-1">
                ...
                <div class="mt-2 flex flex-col gap-2">
                  <a href="#"
                     class="inline-flex w-full items-center justify-center rounded-full px-3 py-1.5 text-sm font-semibold border border-black/15 hover:bg-gray-50">
                    Download
                  </a>
                </div>
              </div>
