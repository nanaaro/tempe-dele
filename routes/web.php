...
Route::middleware('checksession')->group(function () {
    ...
    Route::prefix('ketua-tim')->name('ketua-tim.')->group(function () {
        ...
        Route::post('/pengajuan/{id}/approve', [LemburController::class, 'approve'])->name('ketua-tim.pengajuan.approve')->middleware('checksession');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/pengguna',                    [PenggunaController::class, 'index'])->name('pengguna');
        Route::get('/pengguna/all',                [PenggunaController::class, 'getAll'])->name('pengguna.all');
        Route::post('/pengguna/sinkron',           [PenggunaController::class, 'sinkronPegawai'])->name('pengguna.sinkron'); // ← tambah ini
        Route::post('/pengguna',                   [PenggunaController::class, 'store'])->name('pengguna.store');
        Route::put('/pengguna/{id}',               [PenggunaController::class, 'update'])->name('pengguna.update');
        Route::put('/pengguna/{id}/password',      [PenggunaController::class, 'updatePassword'])->name('pengguna.password');
        Route::delete('/pengguna/{id}',            [PenggunaController::class, 'destroy'])->name('pengguna.destroy');
